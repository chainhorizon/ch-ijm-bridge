...
class Sended extends skynode_1.DomNode {
    ...
    async load() {
        ...
        this.empty().append((0, skynode_1.el)(".message", `${ethers_1.utils.formatEther(sended)} IJM`), received === true ? (0, skynode_1.el)(".done", "전송 완료") : (0, skynode_1.el)("a.retry-button", "재시도", {
            click: () => this.retry(),
        }));
    }
    delete() {
