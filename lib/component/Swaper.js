            ...
            if (receiver === _receiver) {
                try {
                    const result = await superagent_1.default
                        .get(`https://api.chainhorizon.org/ijm/signsend?receiver=${receiver}&fromChain=${this.fromForm.chainId}&toChain=${this.toForm.chainId}&sender=${sender}&sendId=${sendId}&amount=${amount.toString()}`)
                        .send();
