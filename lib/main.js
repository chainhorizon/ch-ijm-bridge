...
(async () => {
    skynode_1.BodyNode.append((0, skynode_1.el)("h1", (0, skynode_1.el)(".logo", "Chain Horizon", { href: "/" }), (0, skynode_1.el)(".ijm", (0, skynode_1.el)("a", "인절미", {
        href: "https://tteok.org",
        target: "_blank",
    }), "브릿지")), (0, skynode_1.el)(".warning", "🚨 브릿지를 이용하기 위해서는 양쪽 체인에 가스비가 필요합니다.\n🚨 한번 전송이 시작되면 돌이킬 수 없습니다. 취소가 불가능합니다."), new Swaper_1.default(), (0, skynode_1.el)("footer", (0, skynode_1.el)("a", "© Chain Horizon", {
